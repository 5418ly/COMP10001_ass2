...
def valid_study_group(zbinis, group):
    ...
    return robot.validate_group(group)
...
example_zbinis = [(0, ['FoC', 'Calc 1', 'Logic']), (1, ['FoA', 'Calc 2', 'Logic']), (2, ['FoC', 'Calc 1', 'Logic']), (3, ['FoC', 'Calc 1', 'Logic']), (0, ['Calc 2', 'History', 'Politics']), (256, ['FoC', 'Calc 1', 'Logic'])]
print(valid_study_group(example_zbinis, (0, 1, 256)))
print(valid_study_group(example_zbinis, (0, 1, 5)))
print(valid_study_group(example_zbinis, (0, 1, 2, 4)))
